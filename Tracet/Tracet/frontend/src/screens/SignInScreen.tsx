    ...
    const handleSignIn = async () => {
        ...
        try {
            ...
            if (!isEmail) {
                ...
                const requestUrl = `${baseUrl}/api/auth/resolve-email?username=${encodeURIComponent(cleanUsername)}`;
                ...
                if (!data?.email) throw new Error('USERNAME_NOT_FOUND');
                ...
                >
                    ...
                    >
                        <View style={styles.headerContainer}>
                            ...
                            <Text style={styles.subtitle}>CONTINUE TRACING YOUR JOURNEYS</Text>
                        </View>
